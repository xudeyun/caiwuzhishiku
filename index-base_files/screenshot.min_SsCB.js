...
var html2canvas = (function () {
  ...
  for (
    var p = function (A, e) {
        return f.fromClientRect(A, e.getBoundingClientRect())
      },
      Q = function (A) {
      ...
      next: function () {
        ...
        for (
          ...
          (A = (function (A, e, t, r, B) {
            ...
            if (h(23, V, n, e)) return tA
            if (h([M, S], O, n, e)) return tA
            if (h(12, 12, n, e)) return tA
            if (i === D) return '÷'
  ...
  function UA(A) {
    return lA(A) || (65 <= A && A <= 70) || (97 <= A && A <= 102)
  }
  function CA(A) {
  ...
  function fA(A, e, t) {
    return 43 === A || 45 === A ? !!lA(e) || (46 === e && lA(t)) : lA(46 === A ? e : A)
  }
  var HA = { type: 2 },
    pA = { type: 3 },
    EA = { type: 4 },
    ...
    PA =
      ...
      (XA.prototype.consumeToken = function () {
        ...
        switch (A) {
          ...
          case 85:
            ...
            return (
              43 !== o || (!UA(i) && 63 !== i) || (this.consumeCodePoint(), this.consumeUnicodeRangeToken()),
      ...
      (XA.prototype.consumeUnicodeRangeToken = function () {
        ...
        if (45 === this.peekCodePoint(0) && UA(this.peekCodePoint(1))) {
          this.consumeCodePoint()
          for (var e = this.consumeCodePoint(), B = []; UA(e) && B.length < 6; )
      ...
      (XA.prototype.consumeNumber = function () {
        ...
        if (46 === t && lA(r))
          for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), e = 8; lA(this.peekCodePoint(0)); )
            A.push(this.consumeCodePoint())
        t = this.peekCodePoint(0)
        var r = this.peekCodePoint(1),
          B = this.peekCodePoint(2)
        if ((69 === t || 101 === t) && (((43 === r || 45 === r) && lA(B)) || lA(r)))
          for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), e = 8; lA(this.peekCodePoint(0)); )
            A.push(this.consumeCodePoint())
        return [
          (function (A) {
      ...
      (XA.prototype.consumeEscapedCodePoint = function () {
        ...
        if (UA(e)) {
          for (var t = g(e); UA(this.peekCodePoint(0)) && t.length < 6; ) t += g(this.consumeCodePoint())
  ...
  function Be(A, e, t) {
    var r = A[0],
      A = A[1]
    return [le(r, e), le(void 0 !== A ? A : r, t)]
  }
  function ne(A) {
  ...
  function pe(A, t) {
    ...
    for (var B = [], n = 0, s = 0; s < A.length; s++) {
      var o = A[s].stop
      null !== o ? (n < (o = le(o, t)) ? B.push(o) : B.push(n), (n = o)) : B.push(null)
    }
  ...
  var Ke = function (A, e) {
      var t = e.filter($A),
        ...
        n = t[2],
        e = t[3],
        t = (17 === r.type ? Ce(r.number) : Ue(A, r)) / (2 * Math.PI),
        A = te(B) ? B.number / 100 : 0,
        r = te(n) ? n.number / 100 : 0,
        B = void 0 !== e && te(e) ? le(e, 1) : 1
      ...
      return (
        Ae(A).forEach(function (A, e) {
          if (0 === e) {
            ...
            if (ne(e)) return void (r = (Ue(t, e) + Ce(270)) % Ce(360))
          }
          A = He(t, A)
          B.push(A)
        }),
  ...
  function Ye(A, e) {
    return _A(A) && 'normal' === A.value ? 1.2 * e : 17 === A.type ? e * A.number : te(A) ? le(A, e) : e
  }
  var We,
    Ze,
    _e = {
  ...
  var Jt = {
    ...
    ar =
      ...
      gr)
  function gr(A, e) {
    ;(this.animationDuration = Ur(A, nr, e.animationDuration)),
      (this.backgroundClip = Ur(A, be, e.backgroundClip)),
      (this.backgroundColor = Ur(A, De, e.backgroundColor)),
      (this.backgroundImage = Ur(A, Re, e.backgroundImage)),
      (this.backgroundOrigin = Ur(A, Ne, e.backgroundOrigin)),
      (this.backgroundPosition = Ur(A, Pe, e.backgroundPosition)),
      (this.backgroundRepeat = Ur(A, Xe, e.backgroundRepeat)),
      (this.backgroundSize = Ur(A, _e, e.backgroundSize)),
      (this.borderTopColor = Ur(A, je, e.borderTopColor)),
      (this.borderRightColor = Ur(A, ze, e.borderRightColor)),
      (this.borderBottomColor = Ur(A, $e, e.borderBottomColor)),
      (this.borderLeftColor = Ur(A, At, e.borderLeftColor)),
      (this.borderTopLeftRadius = Ur(A, et, e.borderTopLeftRadius)),
      (this.borderTopRightRadius = Ur(A, tt, e.borderTopRightRadius)),
      (this.borderBottomRightRadius = Ur(A, rt, e.borderBottomRightRadius)),
      (this.borderBottomLeftRadius = Ur(A, Bt, e.borderBottomLeftRadius)),
      (this.borderTopStyle = Ur(A, nt, e.borderTopStyle)),
      (this.borderRightStyle = Ur(A, st, e.borderRightStyle)),
      (this.borderBottomStyle = Ur(A, ot, e.borderBottomStyle)),
      (this.borderLeftStyle = Ur(A, it, e.borderLeftStyle)),
      (this.borderTopWidth = Ur(A, Qt, e.borderTopWidth)),
      (this.borderRightWidth = Ur(A, ct, e.borderRightWidth)),
      (this.borderBottomWidth = Ur(A, at, e.borderBottomWidth)),
      (this.borderLeftWidth = Ur(A, gt, e.borderLeftWidth)),
      (this.boxShadow = Ur(A, or, e.boxShadow)),
      (this.color = Ur(A, wt, e.color)),
      (this.direction = Ur(A, lt, e.direction)),
      (this.display = Ur(A, Ut, e.display)),
      (this.float = Ur(A, ut, e.cssFloat)),
      (this.fontFamily = Ur(A, jt, e.fontFamily)),
      (this.fontSize = Ur(A, zt, e.fontSize)),
      (this.fontStyle = Ur(A, er, e.fontStyle)),
      (this.fontVariant = Ur(A, Ar, e.fontVariant)),
      (this.fontWeight = Ur(A, $t, e.fontWeight)),
      (this.letterSpacing = Ur(A, Ft, e.letterSpacing)),
      (this.lineBreak = Ur(A, ht, e.lineBreak)),
      (this.lineHeight = Ur(A, dt, e.lineHeight)),
      (this.listStyleImage = Ur(A, ft, e.listStyleImage)),
      (this.listStylePosition = Ur(A, Ht, e.listStylePosition)),
      (this.listStyleType = Ur(A, pt, e.listStyleType)),
      (this.marginTop = Ur(A, Et, e.marginTop)),
      (this.marginRight = Ur(A, It, e.marginRight)),
      (this.marginBottom = Ur(A, yt, e.marginBottom)),
      (this.marginLeft = Ur(A, Kt, e.marginLeft)),
      (this.opacity = Ur(A, Zt, e.opacity))
    var t = Ur(A, mt, e.overflow)
    ;(this.overflowX = t[0]),
      (this.overflowY = t[1 < t.length ? 1 : 0]),
      (this.overflowWrap = Ur(A, Lt, e.overflowWrap)),
      (this.paddingTop = Ur(A, bt, e.paddingTop)),
      (this.paddingRight = Ur(A, Dt, e.paddingRight)),
      (this.paddingBottom = Ur(A, vt, e.paddingBottom)),
      (this.paddingLeft = Ur(A, xt, e.paddingLeft)),
      (this.paintOrder = Ur(A, ir, e.paintOrder)),
      (this.position = Ur(A, St, e.position)),
      (this.textAlign = Ur(A, Mt, e.textAlign)),
      (this.textDecorationColor = Ur(A, _t, null !== (t = e.textDecorationColor) && void 0 !== t ? t : e.color)),
      (this.textDecorationLine = Ur(A, qt, null !== (t = e.textDecorationLine) && void 0 !== t ? t : e.textDecoration)),
      (this.textShadow = Ur(A, Tt, e.textShadow)),
      (this.textTransform = Ur(A, Gt, e.textTransform)),
      (this.transform = Ur(A, Ot, e.transform)),
      (this.transformOrigin = Ur(A, Rt, e.transformOrigin)),
      (this.visibility = Ur(A, Nt, e.visibility)),
      (this.webkitTextStrokeColor = Ur(A, Qr, e.webkitTextStrokeColor)),
      (this.webkitTextStrokeWidth = Ur(A, cr, e.webkitTextStrokeWidth)),
      (this.wordBreak = Ur(A, Jt, e.wordBreak)),
      (this.zIndex = Ur(A, Yt, e.zIndex))
  }
  for (
    var wr = function (A, e) {
        ;(this.content = Ur(A, tr, e.content)), (this.quotes = Ur(A, sr, e.quotes))
      },
      lr = function (A, e) {
        ;(this.counterIncrement = Ur(A, rr, e.counterIncrement)), (this.counterReset = Ur(A, Br, e.counterReset))
      },
      Ur = function (A, e, t) {
        var r = new PA(),
              ...
              ? Xr.SUPPORT_RANGE_BOUNDS
                ? 1 < (r = Wr(s, i, A.length).getClientRects()).length
                  ? ((e = Zr(A)),
                    (t = 0),
                    e.forEach(function (A) {
                      o.push(new Jr(A, f.fromDOMRectList(B, Wr(s, t + i, A.length).getClientRects()))), (t += A.length)
                    }))
                  : o.push(new Jr(A, f.fromDOMRectList(B, r)))
      ...
      (t.type !== hB && t.type !== dB) ||
        ...
        (t.bounds =
          (e = t.bounds).width > e.height
            ? new f(e.left + (e.width - e.height) / 2, e.top, e.height, e.height)
            : e.width < e.height
            ? new f(e.left, e.top + (e.height - e.width) / 2, e.width, e.width)
            : e)),
      t.type)
    ) {
      case hB:
  ...
  var gn,
    ...
    Fn = function (A, e, t) {
      ...
      switch (e) {
        ...
        case 12:
        case 49:
          return sn(A, 1, 9999, ln, 3, r)
        case 35:
          return sn(A, 1, 9999, ln, 3, r).toLowerCase()
        case 13:
    ...
    dn =
      ...
      (fn.prototype.cloneNode = function (A, e) {
        ...
        if (t && XB(A) && (JB(A) || YB(A))) {
          ...
          ;(t = this.counters.parse(new lr(this.context, B))), (n = this.resolvePseudoContent(A, r, n, gn.BEFORE))
      ...
      (fn.prototype.resolvePseudoContent = function (o, A, e, t) {
        ...
        if (e) {
          ...
          if (Q && r && 'none' !== r && '-moz-alt-content' !== r && 'none' !== e.display) {
            this.counters.parse(new lr(this.context, e))
  ...
  var As,
    es = function (A) {
      ...
      var a = t.width - n,
        ...
        F = e.borderLeftWidth,
        h = le(e.paddingTop, A.bounds.width),
        d = le(e.paddingRight, A.bounds.width),
        f = le(e.paddingBottom, A.bounds.width),
        A = le(e.paddingLeft, A.bounds.width)
      ;(this.topLeftBorderDoubleOuterBox =
        0 < r || 0 < B
          ? ss(t.left + F / 3, t.top + U / 3, r - F / 3, B - U / 3, As.TOP_LEFT)
          : new Zn(t.left + F / 3, t.top + U / 3)),
        (this.topRightBorderDoubleOuterBox =
          0 < r || 0 < B
            ? ss(t.left + a, t.top + U / 3, n - C / 3, s - U / 3, As.TOP_RIGHT)
            : new Zn(t.left + t.width - C / 3, t.top + U / 3)),
        ...
        (this.bottomLeftBorderDoubleOuterBox =
          0 < Q || 0 < c
            ? ss(t.left + F / 3, t.top + l, Q - F / 3, c - u / 3, As.BOTTOM_LEFT)
            : new Zn(t.left + F / 3, t.top + t.height - u / 3)),
        (this.topLeftBorderDoubleInnerBox =
          0 < r || 0 < B
            ? ss(t.left + (2 * F) / 3, t.top + (2 * U) / 3, r - (2 * F) / 3, B - (2 * U) / 3, As.TOP_LEFT)
            : new Zn(t.left + (2 * F) / 3, t.top + (2 * U) / 3)),
        (this.topRightBorderDoubleInnerBox =
          0 < r || 0 < B
            ? ss(t.left + a, t.top + (2 * U) / 3, n - (2 * C) / 3, s - (2 * U) / 3, As.TOP_RIGHT)
            : new Zn(t.left + t.width - (2 * C) / 3, t.top + (2 * U) / 3)),
        ...
        (this.bottomLeftBorderDoubleInnerBox =
          0 < Q || 0 < c
            ? ss(t.left + (2 * F) / 3, t.top + l, Q - (2 * F) / 3, c - (2 * u) / 3, As.BOTTOM_LEFT)
            : new Zn(t.left + (2 * F) / 3, t.top + t.height - (2 * u) / 3)),
        (this.topLeftBorderStroke =
          0 < r || 0 < B
            ? ss(t.left + F / 2, t.top + U / 2, r - F / 2, B - U / 2, As.TOP_LEFT)
            : new Zn(t.left + F / 2, t.top + U / 2)),
        (this.topRightBorderStroke =
          0 < r || 0 < B
            ? ss(t.left + a, t.top + U / 2, n - C / 2, s - U / 2, As.TOP_RIGHT)
            : new Zn(t.left + t.width - C / 2, t.top + U / 2)),
        ...
        (this.bottomLeftBorderStroke =
          0 < Q || 0 < c
            ? ss(t.left + F / 2, t.top + l, Q - F / 2, c - u / 2, As.BOTTOM_LEFT)
        ...
        (this.bottomLeftBorderBox =
          0 < Q || 0 < c ? ss(t.left, t.top + l, Q, c, As.BOTTOM_LEFT) : new Zn(t.left, t.top + t.height)),
        (this.topLeftPaddingBox =
          0 < r || 0 < B
            ? ss(t.left + F, t.top + U, Math.max(0, r - F), Math.max(0, B - U), As.TOP_LEFT)
            : new Zn(t.left + F, t.top + U)),
        (this.topRightPaddingBox =
          0 < n || 0 < s
            ...
            : new Zn(t.left + t.width - C, t.top + U)),
        ...
        (this.bottomLeftPaddingBox =
          0 < Q || 0 < c
            ? ss(t.left + F, t.top + Math.min(l, t.height - u), Math.max(0, Q - F), Math.max(0, c - u), As.BOTTOM_LEFT)
            : new Zn(t.left + F, t.top + t.height - u)),
        (this.topLeftContentBox =
          0 < r || 0 < B
            ? ss(t.left + F + A, t.top + U + h, Math.max(0, r - (F + A)), Math.max(0, B - (U + h)), As.TOP_LEFT)
            : new Zn(t.left + F + A, t.top + U + h)),
        (this.topRightContentBox =
          0 < n || 0 < s
            ...
            : new Zn(t.left + t.width - (C + d), t.top + U + h)),
        ...
        (this.bottomLeftContentBox =
          0 < Q || 0 < c
            ? ss(t.left + F + A, t.top + l, Math.max(0, Q - (F + A)), c - (u + f), As.BOTTOM_LEFT)
  ...
  function Us(A) {
    var e = A.styles,
      t = A.bounds,
      r = le(e.paddingLeft, t.width),
      B = le(e.paddingRight, t.width),
      n = le(e.paddingTop, t.width),
      A = le(e.paddingBottom, t.width)
    return t.add(
      r + e.borderLeftWidth,
      n + e.borderTopWidth,
  ...
  function Cs(A, e, t) {
    var r = ((B = Es(A.styles.backgroundOrigin, e)), (n = A), 0 === B ? n.bounds : (2 === B ? Us : ls)(n)),
      B = ((s = Es(A.styles.backgroundClip, e)), (o = A), 0 === s ? o.bounds : (2 === s ? Us : ls)(o)),
  ...
  var hs = function (Q, c, a, g) {
    ...
    ds = function (A, e) {
      for (var t = A instanceof lB ? A.start : 1, r = A instanceof lB && A.reversed, B = 0; B < e.length; B++) {
        var n = e[B]
    ...
    ps = function (A, e, t) {
      var r = e[0],
        ...
        o = A[1]
      if (!s) return [0, 0]
      if (te(s) && o && te(o)) return [le(s, t.width), le(o, t.height)]
      var i = Fs(n)
      ...
      if (i) {
        var c = 0,
          a = 0
        return (
          te(s) ? (c = le(s, t.width)) : te(o) && (a = le(o, t.height)),
      ...
      ;(c = null), (a = null)
      if (
        (te(s) ? (c = le(s, t.width)) : o && te(o) && (a = le(o, t.height)),
        null !==
          (c =
  ...
  var Ls,
    ...
    bs =
            ...
            switch (A.label) {
              ...
              case 19:
                w.listValue &&
                  ...
                  (g = new f(
                    e.bounds.left,
                    e.bounds.top + le(e.styles.paddingTop, e.bounds.width),
                    e.bounds.width,
      ...
      (Ds.prototype.renderStackContent = function (C) {
        return a(this, void 0, void 0, function () {
          var e, t, r, B, n, s, o, i, Q, c, a, g, w, l, U
          return H(this, function (A) {
            switch (A.label) {
              case 0:
              ...
              case 7:
                return r < B.length ? ((U = B[r]), [4, this.renderNode(U)]) : [3, 10]
              case 8:
                A.sent(), (A.label = 9)
              case 9:
                return r++, [3, 7]
            ...
            switch (A.label) {
              case 0:
                ;(h = f.styles.backgroundImage.length - 1),
                  (e = function (e) {
                    var t, r, B, n, s, o, i, Q, c, a, g, w, l, U, C, u, F
                    return H(this, function (A) {
                      switch (A.label) {
                        case 0:
                        ...
                        case 5:
                          1 === e.type
                            ? ((F = Cs(f, h, [null, null, null])),
                              ...
                              pe(e.stops, U).forEach(function (A) {
                            ...
                            : 2 === e.type &&
                              ...
                              (c = u[3]),
                              (a = u[4]),
                              (U = 0 === e.position.length ? [ge] : e.position),
                              (g = le(U[0], c)),
                              (w = le(U[U.length - 1], a)),
                              (C = (function (A, e, t, r, B) {
                                ...
                                return (
                                  Array.isArray(A.size) &&
                                    ((Q = le(A.size[0], r)), (c = 2 === A.size.length ? le(A.size[1], B) : Q)),
                                  [Q, c]
                                )
                              })(e, g, w, c, a)),
                              (F = C[0]),
                              ...
                              0 < F &&
                                0 < u &&
                                ((l = d.ctx.createRadialGradient(i + g, Q + w, 0, i + g, Q + w, F)),
                                ...
                                (d.ctx.fillStyle = l),
                                F !== u
                                  ? ((U = f.bounds.left + 0.5 * f.bounds.width),
      ...
      (Ds.prototype.renderDashedDottedBorder = function (g, w, l, U, C) {
        return a(this, void 0, void 0, function () {
          ...
          return H(this, function (A) {
            return (
              ...
              (B = 0 === l || 2 === l ? Math.abs(t - r) : Math.abs(s - o)),
              this.ctx.beginPath(),
  ...
  var Js = function (F, h) {
      return a(void 0, void 0, void 0, function () {
        var e, t, r, B, n, s, o, i, Q, c, a, g, w, l, U, C, u
        return H(this, function (A) {
          switch (A.label) {
            case 0:
              ...
              return ((l = {
                allowTaint: null !== (U = h.allowTaint) && void 0 !== U && U,
                imageTimeout: null !== (a = h.imageTimeout) && void 0 !== a ? a : 15e3,
                proxy: h.proxy,
                useCORS: null !== (g = h.useCORS) && void 0 !== g && g,
              }),
              (U = d({ logging: null === (w = h.logging) || void 0 === w || w, cache: h.cache }, l)),
              (a = {
                windowWidth: null !== (a = h.windowWidth) && void 0 !== a ? a : t.innerWidth,
                windowHeight: null !== (g = h.windowHeight) && void 0 !== g ? g : t.innerHeight,
                scrollX: null !== (w = h.scrollX) && void 0 !== w ? w : t.pageXOffset,
                scrollY: null !== (l = h.scrollY) && void 0 !== l ? l : t.pageYOffset,
              }),
              (g = new f(a.scrollX, a.scrollY, a.windowWidth, a.windowHeight)),
              (w = new Ps(U, g)),
              (a = null !== (l = h.foreignObjectRendering) && void 0 !== l && l),
              (l = {
                allowTaint: null !== (U = h.allowTaint) && void 0 !== U && U,
                onclone: h.onclone,
              ...
              (U = new dn(w, F, l)),
              (l = U.clonedReferenceElement))
                ? ((r = function (A) {
                    return new Array(A).fill('x').join('')
                  }),
                  h.mask &&
                    (function e(A) {
                      A.forEach(function (A) {
                        PB(A) && A.data
                          ? (A.data = r(A.data.trim().length))
                          : _B(A)
                          ? (A.placeholder && (A.placeholder = r(A.placeholder.length)),
                            A.value && (A.value = r(A.value.length)))
                          : zB(A)
                          ? (A.height = A.height)
                          : $B(A)
                          ? (A.src = '')
                          : qB(A)
                          ? (A.innerHTML = '')
                          : A.hasChildNodes && A.hasChildNodes() && e(A.childNodes)
                      })
                    })([l]),
                  [4, U.toIFrame(e, g)])
            ...
            case 1:
              ...
              (o = C.left),
              (i = C.top),
              (Q = Ys(w, l, h.backgroundColor)),
              (C = {
                canvas: h.canvas,
                backgroundColor: Q,
                scale:
                  null !== (C = null !== (C = h.scale) && void 0 !== C ? C : t.devicePixelRatio) && void 0 !== C
                    ? C
                    : 1,
                x: (null !== (C = h.x) && void 0 !== C ? C : 0) + o,
                y: (null !== (C = h.y) && void 0 !== C ? C : 0) + i,
                width: null !== (C = h.width) && void 0 !== C ? C : Math.ceil(n),
                height: null !== (C = h.height) && void 0 !== C ? C : Math.ceil(s),
              }),
              a)
                ? (w.logger.debug('Document cloned, using foreign object rendering'), [4, new Os(w, C).render(l)])
                : [3, 3]
            case 2:
              return (c = A.sent()), [3, 5]
            case 3:
              return (
                ...
                (u = kB(w, l)),
                Q === u.styles.backgroundColor && (u.styles.backgroundColor = Le.TRANSPARENT),
                w.logger.debug(
                  'Starting renderer for element at ' + C.x + ',' + C.y + ' with size ' + C.width + 'x' + C.height,
                ),
                [4, new bs(w, C).render(u)]
              )
            case 4:
              ;(c = A.sent()), (A.label = 5)
            case 5:
              return (
                (null !== (u = h.removeContainer) && void 0 !== u && !u) ||
                  dn.destroy(B) ||
                  w.logger.error('Cannot detach cloned iframe as it is not in the DOM anymore'),
